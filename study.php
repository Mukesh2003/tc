...
// else{
    ...
    if(isset($_POST['print'])){  
        ...
        if($num['Study_taken']!='yes'){
            $query3= "UPDATE `samplestudent1` SET `Study_taken`='yes' WHERE `RollNumber`='".$id."'";
            $query_run3=mysqli_query($conn,$query3);
        }
        // if($num)
        // {
        //     $query1= "UPDATE `` SET `dup`='DUPLICATE' WHERE `Roll_Number`='".$idd."'";
...
<div>
<center>
<table><tr><td width = 700 > </font></td>
<td align="right"> <input type="text"  name="dup" value= "<?php 
      if($row['Study_taken']=='yes'){
        echo "DUPLICATE";
      }
     ?>"></td>    
</tr></table>
