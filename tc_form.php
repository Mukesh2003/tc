...
<td></td>
<td align="right"> <input type="text"  name="dup" style="font-size:15px;"  value= "<?php 
      if($row['Tc_taken']=='yes'){
        echo "DUPLICATE";
      }
     ?>"></td>
...
<tr>
<td width=300 align="left" style="font-size:20px;">Adm.No:<input type="text" name="admin_no" style="font-size:20px;" value = "<?php    
       echo strtoupper($id);
    ?>"></td>
   ...
   <?php
    ...
    ?>
<td width=300 align="right" style="font-size:20px;">Date:<input type="text" name="date" style="font-size:20px;" value="<?php
